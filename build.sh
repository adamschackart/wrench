...
if false; then
    ...
    cc -O0 -g -I. -Iwren/src/include -Wno-format-zero-length -Wno-format-truncation -fPIC -shared -o rect.so rect.c wren.o -lm -ldl &
    ...
    cc -O0 -g -DWRENCH_STDLIB=1 -I. -Iwren/src/include -Wno-format-zero-length -Wno-format-truncation -o run_wren main.c wren.c -lm -ldl
fi
